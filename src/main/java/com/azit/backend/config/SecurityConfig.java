...
import com.azit.backend.service.CustomOAuth2UserService;
...
public class SecurityConfig {
    ...
    private final OAuth2LoginSuccessHandler oAuth2LoginSuccessHandler; // ★ 안내원 추가
